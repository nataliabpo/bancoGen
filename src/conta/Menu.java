...
public class Menu {
	...
	public static void main(String[] args) {
		...
		System.out.println("\nCriar Contas\n");
		ContaCorrente cc1 = new ContaCorrente(contas.gerarNumero(), 123, 1, "Maria José", 1000f, 100.0f);
		contas.cadastrar(cc1);
		ContaCorrente cc2 = new ContaCorrente(contas.gerarNumero(), 124, 1, "Edileuza Batista", 2000f, 100.0f);
		contas.cadastrar(cc2);
		ContaCorrente cp1 = new ContaCorrente(contas.gerarNumero(), 125, 2, "Lucineide Cavalcanti", 4000f, 12);
		contas.cadastrar(cp1);
		ContaCorrente cp2 = new ContaCorrente(contas.gerarNumero(), 126, 2, "Terezinha de Jesus", 8000f, 15);
		...
		while (true) {
			...
			case 8:
				...
				System.out.println("Digite da Conta de Origem: ");
				numero = leia.nextInt();
				System.out.println("Digite da Conta de Destino: ");
